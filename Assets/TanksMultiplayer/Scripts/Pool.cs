...
namespace TanksMP
{
    ...
    public class Pool : MonoBehaviour
    {
        ...
        //this would normally go into Awake(), but due to a bug with Unity/Mirror calling
        //NetworkScenePostProcess.cs > OnPostProcessScene and thinking these are scene objects,
        //resulting in Debug.LogErrors telling resaving the scene, this has to be in Start instead 
        void Start()
        {
            PreLoad();   
        }
        ...
        //method called by Unity Networking's spawning system on Network.Spawn
        GameObject OnSpawn(Vector3 position, Guid assetId)
        {
            //just call our regular spawn method
